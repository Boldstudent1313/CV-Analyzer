...
- Weighting layer adjusts base semantic scores from external signals
...
Deployment:
- Designed to run on Render Python builder; top-level `app = Flask(__name__)` is guaranteed
